...
> Built from scratch — no drag-and-drop tools, pure Python.
...
```
Telegram → FastAPI Gateway → Orchestrator Agent
                                      ↓
                      RESEARCH / WRITE / CHAT decision
                            ↓          ↓         ↓
                       Research     Writer      Chat
                        Agent        Agent      (LLM)
                          ↓             ↓
                     Web Search    File Writer
                    (DuckDuckGo)   (notes/*.md)
                            ↓
                          Ollama
                            ↓
